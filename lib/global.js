...
function displayZones(val){
	...
	switch(val){
		case 1:
			...
			$('#zoneAcc').hide();
			$('#zoneFor').hide();
			$('#tb').removeClass().addClass("menuitem_active");
			$('#mc').removeClass().addClass("menuitem");
			$('#lf').removeClass().addClass("menuitem");
			$('#accDatas').hide();
			$('#lesFormsDatas').hide();												
			break;
		case 2:
			...
			$('#zoneAcc').show();
			$('#zoneFor').hide();
			$('#tb').removeClass().addClass("menuitem");
			$('#mc').removeClass().addClass("menuitem_active");
			$('#lf').removeClass().addClass("menuitem");
			$('#accDatas').show();
			$('#lesFormsDatas').hide();								
			break;
		case 3:
			...
			$('#tb').removeClass().addClass("menuitem");
			$('#mc').removeClass().addClass("menuitem");
			$('#lf').removeClass().addClass("menuitem_active");
			$('#accDatas').hide();
			$('#lesFormsDatas').show();										
			break;            			
	}
...
function updateUsersDiv(users){
    ...
    for (let i = 0; i < users.length; i++) {
		...
		if(JSONData["level"] == 0)
    		tab += "<td><div id='m_"+i+"' class='userbtn'>Modifier</div></td><td><div id='d_"+i+"' class='userbtn'>Supprimer</div></td>";            	            	
    	tab += "<td><div id='v_"+i+"' class='userbtn'>Voir</div></td></tr>";           
    }
	tab +="</table>";
	$('#users').html(tab);
